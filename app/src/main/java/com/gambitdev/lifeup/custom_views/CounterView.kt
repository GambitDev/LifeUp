    ...
    init {
        ...
        labelPaint.apply {
            ...
            color = attributes.getColor(
                R.styleable.CounterView_labelColor,
        ...
        counterTextPaint.apply {
            ...
            textSize = attributes.getDimension(
                R.styleable.CounterView_counterTextSize,
        ...
        progressBarArcPaint.apply {
            style = Paint.Style.FILL
            color = attributes.getColor(
                R.styleable.CounterView_progressColor,
        ...
        progressWidth = attributes.getDimension(
            R.styleable.CounterView_progressWidth,
